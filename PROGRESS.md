...
- **DialogueZone — emoji par ligne** : tableau `_lineEmojis` parallèle à `_lines`, affiché dans une Image dédiée `_emojiImage` (masquée si la ligne n'a pas d'emoji). Le portrait reste celui du personnage.
